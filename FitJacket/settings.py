...
SECRET_KEY = 'django-insecure-r8jg7$!s7nn7sjj@dh=k5h3lq*%)970xfumys&)o929sp$z^d_'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.admin_group',
                'friends.context_processors.user_groups',
            ],
        },
    },
]
